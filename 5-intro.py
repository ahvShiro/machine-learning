...
primeiros_10 = lista[0:10:1]
print(primeiros_10)

# 2- capturar os últimos 10 elementos e imprimir na tela
ultimos_10 = lista[-10::1]
print(ultimos_10)

# 3- capturar os 10 elementos do meio e imprimir na tela
meio = int(tam/2)
meio_lista = lista[meio-5:meio+5]
print(meio_lista)

# 4- imprimir o 21o elemento apenas
vigesimo_primeiro = lista[21]
print(vigesimo_primeiro)

# 5- imprimir todos elementos, menos os 5 últimos
todos_menos_ultimos_5 = lista[:tam-5:]
print(todos_menos_ultimos_5)

# 6- imprimir todos elementos do início até o meio
inicio_ao_meio = lista[0:meio:1]
print(inicio_ao_meio)

# 7- imprimir todos elementos do meio até o final
meio_ao_fim = lista[meio:tam:1]
print(meio_ao_fim)

# 7.1- imprimir todos os elementos do meio ao fim, em ordem reversa
meio_ao_fim_reverso = lista[-1:meio-1:-1]
print(meio_ao_fim_reverso)

# 8- imprimir todos elementos a partir do 5 , menos os 5 últimos
comeco_cinco_menos_cinco_ultimos = lista[5:-5:1]
print(comeco_cinco_menos_cinco_ultimos)

# 9- imprimir o 12 elemento
decimo_segundo = lista[12]
...
for linha in tabela2:
    print(linha)
print('Quantidade de linhas da tabela 2:', None)

# 15- imprimir as colunas da tabela2
print('Imprimindo colunas', None)
...
meio = tam // 2 # encontra o índice do meio da lista
...
# 6- imprimir todos elementos do início até o meio
meio = tam // 2 # encontra o meio da lista 
